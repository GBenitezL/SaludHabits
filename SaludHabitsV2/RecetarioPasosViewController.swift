//
//  RecetarioPasosViewController.swift
//  SaludHabitsV2
//
...
class RecetarioPasosViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        var pasos = ""
        for i in 0..<recetas[recetaHoy].pasos.count {
            pasos += String(i+1) + "- " + recetas[recetaHoy].pasos[i] + " \n"
        }
        tvPasos.text = pasos
    }
